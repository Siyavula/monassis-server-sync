{
    'records': [
        ...
        {'id': 3, 'column1': 'cc', 'column2': 'c', 'column3': 'c'},    # ii1, volatile: u0
        {'id': 4, 'column1': 'dd', 'column2': 'dd', 'column3': 'd'},   # ii1, volatile: u1
        {'id': 5, 'column1': 'ee', 'column2': 'ee', 'column3': 'ee'},  # ii1, volatile: d
        {'id': 6, 'column1': 'ff', 'column2': 'f', 'column3': 'f'},    # i-,  volatile: u1
        ...
        {'id': 12, 'column1': 'll', 'column2': 'l', 'column3': 'l'},   # uu1, volatile: u0
        {'id': 13, 'column1': 'mm', 'column2': 'm', 'column3': 'm'},   # uu1, volatile: u1
        {'id': 14, 'column1': 'nn', 'column2': 'nn', 'column3': 'nn'}, # uu1, volatile: d
        {'id': 15, 'column1': 'oo', 'column2': 'o', 'column3': 'o'},   # ud,  volatile: u1
        {'id': 16, 'column1': 'pp', 'column2': 'pp', 'column3': 'pp'}, # ud,  volatile: d
        {'id': 17, 'column1': 'qq', 'column2': 'q', 'column3': 'q'},   # u-,  volatile: u0
        {'id': 18, 'column1': 'rr', 'column2': 'r', 'column3': 'r'},   # u-,  volatile: u1
